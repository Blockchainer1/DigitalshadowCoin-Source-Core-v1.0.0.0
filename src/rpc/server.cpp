...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop DigitalShadow server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "DigitalShadow server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DigitalShadow features */
        {"digitalshadow", "listmasternodes", &listmasternodes, true, true, false},
        {"digitalshadow", "getmasternodecount", &getmasternodecount, true, true, false},
        {"digitalshadow", "masternodeconnect", &masternodeconnect, true, true, false},
        {"digitalshadow", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"digitalshadow", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"digitalshadow", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"digitalshadow", "masternodecurrent", &masternodecurrent, true, true, false},
        {"digitalshadow", "masternodedebug", &masternodedebug, true, true, false},
        {"digitalshadow", "startmasternode", &startmasternode, true, true, false},
        {"digitalshadow", "createmasternodekey", &createmasternodekey, true, true, false},
        {"digitalshadow", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"digitalshadow", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"digitalshadow", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"digitalshadow", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"digitalshadow", "getmasternodescores", &getmasternodescores, true, true, false},
        {"digitalshadow", "preparebudget", &preparebudget, true, true, false},
        {"digitalshadow", "submitbudget", &submitbudget, true, true, false},
        {"digitalshadow", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"digitalshadow", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"digitalshadow", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"digitalshadow", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"digitalshadow", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"digitalshadow", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"digitalshadow", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"digitalshadow", "checkbudgets", &checkbudgets, true, true, false},
        {"digitalshadow", "mnsync", &mnsync, true, true, false},
        {"digitalshadow", "spork", &spork, true, true, false},
        {"digitalshadow", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzdshaseed", &getzdshaseed, false, false, true},
        {"zerocoin", "setzdshaseed", &setzdshaseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzdsha", &searchdzdsha, false, false, true},
        {"zerocoin", "dzdshastate", &dzdshastate, false, false, true},
...
{
    return "> digitalshadow-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12241/\n";
}
