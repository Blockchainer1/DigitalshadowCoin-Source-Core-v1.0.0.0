...
#ifndef DigitalShadow_ZDSHAWALLET_H
#define DigitalShadow_ZDSHAWALLET_H
...
public:
    CzDSHAWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZDSHA(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZDSHA(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //DigitalShadow_ZDSHAWALLET_H
