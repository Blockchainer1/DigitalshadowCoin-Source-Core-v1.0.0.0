...
#ifndef DigitalShadow_ZDSHATRACKER_H
#define DigitalShadow_ZDSHATRACKER_H
...
public:
    CzDSHATracker(std::string strWalletFile);
    ~CzDSHATracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzDSHAWallet* zDSHAWallet = NULL);
...
#endif //DigitalShadow_ZDSHATRACKER_H
