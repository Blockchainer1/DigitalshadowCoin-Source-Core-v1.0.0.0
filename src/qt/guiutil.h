...
/** Utility functions used by the DigitalShadow Qt UI.
 */
namespace GUIUtil
{
...
// Render DigitalShadow addresses in monospace font
...
// Parse "digitalshadow:" URI into recipient object, return true on successful parsing
