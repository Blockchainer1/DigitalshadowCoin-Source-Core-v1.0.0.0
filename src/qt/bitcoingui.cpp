                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DigitalShadow Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DigitalShadow address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and digitalshadow: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDSHA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DigitalShadow Core"), this);
    aboutAction->setStatusTip(tr("Show information about DigitalShadow Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for DigitalShadow"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DigitalShadow addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DigitalShadow addresses"));
    ...
    openAction->setStatusTip(tr("Open a DigitalShadow: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DigitalShadow Core help message to get a list with possible DigitalShadow command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DigitalShadow Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DigitalShadow network", "", count));
}
...
{
    QString strTitle = tr("DigitalShadow Core"); // default title
