...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::DSHA);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeDigitalShadowAmount"))
        SoftSetArg("-anonymizedigitalshadowamount", settings.value("nAnonymizeDigitalShadowAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in digitalshadow.cpp during shotdown to also remove the window positions
