...
/* DigitalShadow GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DigitalShadow"
#define QAPP_ORG_DOMAIN "digitalshadow.org"
#define QAPP_APP_NAME_DEFAULT "DigitalShadow-Qt"
#define QAPP_APP_NAME_TESTNET "DigitalShadow-Qt-testnet"
