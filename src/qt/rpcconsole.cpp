                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDSHAPathCustom = GetArg("-zdshabackuppath", "");
    ...
    if(!strzDSHAPathCustom.empty()) {
        ui->wallet_customzdshabackuppath->setText(QString::fromStdString(strzDSHAPathCustom));
        ui->wallet_customzdshabackuppath_label->setVisible(true);
        ui->wallet_customzdshabackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDSHAPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the DigitalShadow RPC console.") + "<br>" +
