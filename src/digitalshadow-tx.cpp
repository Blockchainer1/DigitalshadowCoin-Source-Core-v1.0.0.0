...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DigitalShadow Core digitalshadow-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  digitalshadow-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded digitalshadow transaction") + "\n" +
                               "  digitalshadow-tx [options] -create [commands]   " + _("Create hex-encoded digitalshadow transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded digitalshadow transaction
