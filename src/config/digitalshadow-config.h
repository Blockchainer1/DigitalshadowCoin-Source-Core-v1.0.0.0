/* src/config/digitalshadow-config.h.  Generated from digitalshadow-config.h.in by configure.  */
/* src/config/digitalshadow-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef DSHA_CONFIG_H

#define DSHA_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.digitalshadow.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "DigitalShadow Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "DigitalShadow Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "digitalshadow"
