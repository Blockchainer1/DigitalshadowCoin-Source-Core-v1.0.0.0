...
from fake_stake.base_test import DigitalShadow_FakeStakeTest

class zDSHAwrappedSerialsTest(DigitalShadow_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zDSHAs..." % DENOM_TO_USE)
