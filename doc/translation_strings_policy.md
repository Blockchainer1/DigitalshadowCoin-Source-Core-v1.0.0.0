...
This document provides guidelines for internationalization of the DigitalShadow Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to DigitalShadow network</numerusform>
            <numerusform>%n active connections to DigitalShadow network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `digitalshadow_en.ts` remains unchanged.
