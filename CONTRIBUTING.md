Contributing to DigitalShadow Core
============================

The DigitalShadow Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/digitalshadow-project/digitalshadow/blob/master/doc/translation_process.md)
...
The following applies to code changes to the DigitalShadow Core project, and is not to be
confused with overall DigitalShadow Network Protocol consensus changes.

Whether a pull request is merged into DigitalShadow Core rests with the project merge
...
Patches that change DigitalShadow consensus rules are considerably more involved than
...
Where a patchset proposes to change the DigitalShadow consensus, it must have been
...
The project leader is the release manager for each DigitalShadow Core release.
