...
EXCLUDE = [
    # auto generated:
    'src/qt/digitalshadowstrings.cpp',
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The DigitalShadow developers'
...
Arguments:
    <base_directory> - The base directory of a digitalshadow source code repository.
"""
